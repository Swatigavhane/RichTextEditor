...
import { replaceSelectionWithText } from '../features/editor/model';
...
export const applyInputEvent = (documentModel: Document, change: InputEventChange): Document => {
    ...
    const nextDocument = replaceSelectionWithText(documentModel, change.selection, textDiff.insertedText, []).document;
